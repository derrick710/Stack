...
var Stage = /** @class */function () {
  function Stage() {
    ...
    this.renderer.setClearColor('#FFC0cb', 1);
...
var Block = /** @class */function () {
  function Block(block) {
    ...
    } else
    {
      ...
      var r = Math.sin(0.3 * offset) * 20 + 200;
      var g = Math.sin(0.3 * offset + 2) * 20 + 200;
      var b = Math.sin(0.3 * offset + 4) * 20 + 200;
...
// Add this code to the bottom of the HTML file, inside a <script> tag
